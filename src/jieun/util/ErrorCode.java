...
public enum ErrorCode {
    MENU_OPTION_NOT_FOUND_EXCEPTION(1001, "❗️잘못된 메뉴 번호입니다.❗️"),
    PRODUCT_NOT_FOUND_EXCEPTION(1002, "❗️존재하지 않는 상품 번호입니다.❗️"),
    ...
    INVALID_INPUT_TYPE_EXCEPTION(1006, "❗️잘못된 입력 유형입니다. 다시 입력해주세요.❗️");
